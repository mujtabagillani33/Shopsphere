...
import 'package:my_app/views/auth_screen/signup_screen.dart';
    ...
    return bgWidget(
      child: Scaffold(
        ...
        body: Center(
          child: Column(
            children: [
              // Top padding to space out from the screen top
              (context.screenHeight * 0.1).heightBox,
              applogoWidget(), // App logo widget
              10.heightBox,
              ...
              Obx(
                  ...
                  children: [
                    ...
                    Align(
                      ...
                      child: TextButton(
                          onPressed: () {},
                          child: forgetPass.text.make()), // "Forgot Password"
                    ),
                    5.heightBox,
                      ...
                      children: List.generate(
                        3,
                          ...
                          child: CircleAvatar(
                            ...
                            radius: 25,
                            child: Image.asset(
                              socialIconList[index], // Icons for social login
                              width: 30,
                            ),
                          ),
                        ),
